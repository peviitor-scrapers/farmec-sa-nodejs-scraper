...
|---------|--------|-------------|
| id      | string | CIF/CUI of the company (e.g. "199150"). Exact CIF/CUI 8 digits, no RO prefix |
...
| Field       | Type     | Description |
|-------------|----------|-------------|
| brand       | string   | Commercial brand name (e.g. "FARMEC"). Used for display purposes |
...
| scraperFile | string   | Name of the scraper file used (e.g. "job-seeker-ro-spider.yml"). Used for reference |
